...
- [ ] `PUT /api/accounts/{name}/enable` - 启用/禁用账户

### 1.4 交易监控 API
- [ ] `GET /api/trades/recent` - 获取最近交易（分页）
- [ ] `GET /api/trades/history` - 获取历史交易（筛选）
...
- [ ] `POST /api/risk/alerts/{id}/ack` - 确认告警
